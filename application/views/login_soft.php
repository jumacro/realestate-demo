...
<div class="logo">
	<a href="#">
		<img src="<?php echo base_url();?>ove/_img/int_mainid01.gif" alt="" style="margin-top: 18px;width: 80px;"/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php echo base_url();?>users/validate" method="post">
